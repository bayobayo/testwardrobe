...
test.describe('NSITF', function() {
    ...
    test.it('NSITF', function () {
        ...
        nsitf.regionsmenu(data['type'], data['login']);
        ...
        nsitf.alldynamictext1(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext2(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext3(data['type'], data['alltext'], data['alltextinfo']);        
    });
