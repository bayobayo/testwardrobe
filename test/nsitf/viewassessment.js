...
test.describe('NSITF', function() {
    ...
    test.beforeEach(function () {
        ...
        nsitf.assessmentsmenu(data['type'], data['login'], true)
    });
    test.it('NSITF', function () {
        nsitf.searchassessment(data['type'], data['login'], data['logininfo']);
        nsitf.viewassessment(data['type'], data['login'], data['logininfo'])
