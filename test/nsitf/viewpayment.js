...
test.describe('NSITF', function() {
    ...
    test.beforeEach(function () {
        ...
        nsitf.paymentsmenu(data['type'], data['login'], true)
    });
    test.it('NSITF', function () {
        nsitf.searchpayment(data['type'], data['login'], data['logininfo']);
        nsitf.viewpayment(data['type'], data['login'], data['logininfo'])
