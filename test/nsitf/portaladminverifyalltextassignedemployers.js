...
test.describe('NSITF', function() {
    ...
    test.it('NSITF', function () {
        ...
        nsitf.alldynamictext14(data['type'], data['alltext'], data['alltextinfo']);
        ...
        nsitf.alldynamictext17(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext2(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext10(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext18(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext19(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext20(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext21(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext22(data['type'], data['alltext'], data['alltextinfo']);
