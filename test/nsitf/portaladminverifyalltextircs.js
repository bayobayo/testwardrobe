...
test.describe('NSITF', function() {
    ...
    test.it('NSITF', function () {
        ...
        nsitf.ircsmenu(data['type'], data['login']);
        ...
        nsitf.alldynamictext7(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext8(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext9(data['type'], data['alltext'], data['alltextinfo']);
        ...
        nsitf.alldynamictext11(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext12(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext13(data['type'], data['alltext'], data['alltextinfo']);
    });
