...
test.describe('NSITF', function() {
    ...
    test.it('NSITF', function () {
        ...
        nsitf.alldynamictext4(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext2(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext5(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext6(data['type'], data['alltext'], data['alltextinfo']);        
    });
