...
test.describe('NSITF', function() {
    ...
    test.it('NSITF', function () {
        ...
        nsitf.paymentsmenu(data['type'], data['login']);
        ...
        nsitf.alldynamictext34(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext27(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext35(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext36(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext37(data['type'], data['alltext'], data['alltextinfo']);
        nsitf.alldynamictext38(data['type'], data['alltext'], data['alltextinfo']);
    });
